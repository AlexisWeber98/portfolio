      ...
      <div className="container mx-auto max-w-4xl text-center">
        <div className="space-y-6 md:space-y-8">
          <div className="space-y-4">
            ...
            <h1
              id="hero-heading"
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold  animate-fade-in-up text-balance"
            >
              {PERSONAL_INFO.name}
            </h1>
            <p
              className="text-2xl sm:text-3xl md:text-4xl font-semibold text-foreground animate-fade-in-up animation-delay-200"
              role="doc-subtitle"
            >
          ...
          <nav
            ...
            aria-label={
              locale === "en" ? "Hero actions" : "Acciones principales"
            }
          >
            <Button
              size="lg"
